        ...
        t.addEventListener("change", function () {
          ...
          t.addEventListener("keydown", function (t) {
            ...
            switch (t.which) {
              ...
              case 38:
                !1 === (s = a[1]) && (s = 1),
                  null !== s && e.noUiSlider.setHandle(i, o + s);
                break;
              case 40:
                !1 === (s = a[0]) && (s = 1),
                  null !== s && e.noUiSlider.setHandle(i, o - s);
          ...
          return (
            ...
            this.each(function () {
              ...
              "right" === e.my[0]
                ...
                "bottom" === e.my[1]
                  ? (D.top -= h)
                  : "center" === e.my[1] && (D.top -= h / 2),
                (D.left += I[0]),
                (D.top += I[1]),
                (n = { marginLeft: d, marginTop: _ }),
                t.each(["left", "top"], function (i, s) {
                  t.ui.position[w[i]] &&
                    t.ui.position[w[i]][s](D, {
                      targetWidth: p,
                      targetHeight: f,
                      elemWidth: r,
                      elemHeight: h,
              ...
              function d(e) {
                ...
                (i.mode = c.shift()),
                  !1 === t.uiBackCompat || n
                    ? "none" === i.mode
                      ? (o[h](), a())
                      : s.call(o[0], i, function () {
                          o.removeData(l),
                            t.effects.cleanUp(o),
                            "hide" === i.mode && o.hide(),
                            a();
                        })
                    : (o.is(":hidden") ? "hide" === h : "show" === h)
                    ? (o[h](), a())
                    : s.call(o[0], i, a);
              }
              return !1 === o
    ...
    t.effects,
      ...
      t.effects.define("pulsate", "show", function (e, i) {
        var s = t(this),
          ...
          u = s.queue().length;
        for (
          (!o && s.is(":visible")) || (s.css("opacity", 0).show(), (h = 1));
          c < r;
          c++
        )
          s.animate({ opacity: h }, l, e.easing), (h = 1 - h);
        ...
        : (/^(input|select|textarea|button|object)$/.test(l)
          ...
          a &&
            ...
            (function (t) {
              ...
              for (; "inherit" === e; ) e = (t = t.parent()).css("visibility");
              return "hidden" !== e;
            })(t(e)));
    }),
      t.extend(t.expr[":"], {
          ...
          t.each(
            ...
            function () {
              this.options &&
                (!this.options.disabled &&
                  this.visible &&
                  b(e, this, this.options.tolerance, i) &&
          ...
          t.each(t.ui.ddmanager.droppables[e.options.scope] || [], function () {
            if (!this.options.disabled && !this.greedyChild && this.visible) {
              var s,
                n,
                o,
                a = b(e, this, this.options.tolerance, i),
                r =
                  !a && this.isover
                    ? "isout"
                    : a && !this.isover
      ...
      t.widget("ui.sortable", t.ui.mouse, {
        ...
        _refreshItems: function (e) {
          ...
          for (i = u.length - 1; i >= 0; i--)
            for (a = u[i][1], s = 0, h = (r = u[i][0]).length; s < h; s++)
...
!(function (t, e) {
  ...
  (i = (function () {
      ...
      (this.input = e),
        ...
        t("body")
          .mousemove(function (e) {
            if (n.dragging)
              return (
                n.domDrag(e.pageX, e.pageY),
                t("body").css({ cursor: "pointer" })
              );
          })
          .mouseup(function (e) {
            if (n.dragging)
              return (
                (n.dragging = !1),
                n.dragger.removeClass("dragging"),
                t("body").css({ cursor: "auto" })
              );
          }),
        (this.pagePos = 0),
    ...
    return (
      ...
      (e.prototype.trackEvent = function (t) {
        if (1 === t.which)
          return this.domDrag(t.pageX, t.pageY, !0), (this.dragging = !0), !1;
      }),
      (e.prototype.domDrag = function (t, e, i) {
        ...
        if (
          ...
          return (
            ...
            this.settings.snap
              ? this.setSliderPositionFromValue(o, i)
              : this.setSliderPosition(s, i)
          );
      }),
      (e.prototype.setSliderPosition = function (t, e) {
        if ((null == e && (e = !1), e && this.settings.animate)) {
          if ((this.dragger.animate({ left: t }, 200), this.settings.highlight))
            return this.highlightTrack.animate({ width: t }, 200);
        } else if ((this.dragger.css({ left: t }), this.settings.highlight))
          return this.highlightTrack.css({ width: t });
      }),
        ...
        return (
          ...
          this.settings.allowedValues
            ? ((i = null),
              ...
              i)
            : this.settings.step
            ? ((s = (n.max - n.min) / this.settings.step),
              (o = Math.floor((e - n.min) / this.settings.step)),
              (e - n.min) % this.settings.step > this.settings.step / 2 &&
                o < s &&
                (o += 1),
              o * this.settings.step + n.min)
            : e
        );
      }),
      (e.prototype.valueToRatio = function (t) {
        ...
        if (this.settings.equalSteps) {
          for (
            n = a = 0, r = (l = this.settings.allowedValues).length;
            a < r;
            n = ++a
          )
            (e = l[n]),
              (null == i || Math.abs(e - t) < Math.abs(i - t)) &&
                ((i = e), (s = n));
          return this.settings.snapMid
            ? (s + 0.5) / this.settings.allowedValues.length
            : s / (this.settings.allowedValues.length - 1);
        }
      ...
      (e.prototype.ratioToValue = function (t) {
        ...
        return this.settings.equalSteps
          ? ((o = this.settings.allowedValues.length),
            (n = Math.round(t * o - 0.5)),
            (e = Math.min(n, this.settings.allowedValues.length - 1)),
            this.settings.allowedValues[e])
          : ((s = t * ((i = this.getRange()).max - i.min) + i.min),
            this.nearestValidValue(s));
      }),
      (e.prototype.valueChanged = function (e, i, s) {
        ...
        if (e.toString() !== this.value.toString())
          return (
            ...
            this.input
              .val(e)
              .trigger(t.Event("change", n))
              .trigger("slider:changed", n)
          );
      }),
      e
    );
      ...
      simpleSlider: function () {
        ...
        return (
          ...
          t(this).each(function () {
            var o, a;
            return n && __indexOf.call(s, n) >= 0
              ? (o = t(this).data("slider-object"))[n].apply(o, e)
              : ((a = n), t(this).data("slider-object", new i(t(this), a)));
          })
        );
      },
    }),
        ...
        return (
          ...
          (i = e.data("slider-values")) &&
            (s.allowedValues = (function () {
              var t, e, s, o;
              for (o = [], t = 0, e = (s = i.split(",")).length; t < e; t++)
                (n = s[t]), o.push(parseFloat(n));
              return o;
            })()),
          e.data("slider-range") &&
            (s.range = e.data("slider-range").split(",")),
          ...
          e.attr("data-slider-highlight") &&
            (s.highlight = e.data("slider-highlight")),
          null != e.data("slider-animate") &&
            (s.animate = e.data("slider-animate")),
          e.simpleSlider(s)
        );
      });
    });
  ...
  $(document).ready(function () {
    ...
    function t() {
      ...
      for (
        var p =
            "<thead ><tr class='table-head'><th>Payment No.</th><th>Begining Balance</th><th>EMI</th><th>Principal</th><th>Interest</th><th>Ending Balance</th></thead><tbody>",
          f = parseInt(t),
          g = 0,
          m = 0,
          _ = 0,
    ...
    $("#la").on('input', function (e, i) {
        $("#la_value").trigger("change");
    }),
      $("#nm").on('input', function (e, i) {
        $("#nm_value").trigger("change");
      }),
      $("#roi").on('input',function (e, i) {
        $("#roi_value").trigger("change");
      }),
        t();
        $("#la_value").change(function(){
          t();
        });
        $("#nm_value").change(function(){
            t();
        });
        $("#roi_value").change(function(){
            t();
        });
  ...
  (function () {
    for (
      var t = document.getElementsByTagName("pre"), e = 0;
      e < t.length;
      e++
    ) {
